...
Analysis6GammaCanvas::Analysis6GammaCanvas(const Char_t* Name)
{
	printf("Analysis6GammaCanvas created. Name: %s\n", Name);
...
Analysis6GammaCanvas::~Analysis6GammaCanvas()
{
	
}

void	Analysis6GammaCanvas::Draw()
{
	if(!(canvas	= (TCanvas*)gROOT->Get(name)))
